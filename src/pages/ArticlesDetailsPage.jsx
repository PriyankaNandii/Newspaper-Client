  ...
  return (
    <div className="container mx-auto py-8 mt-20 ">
      <div className="max-w-7xl mx-auto overflow-hidden md:flex bg-white rounded-lg shadow-md dark:bg-gray-800 p-8 gap-14">
        ...
        <div className="md:w-1/2">
          <div>
            <span className="text-lg font-medium text-blue-600 uppercase dark:text-blue-400">
              {article.publisher}
            </span>
          ...
          <div className="mt-4">
            <h2 className="font-bold text-gray-700 dark:text-gray-200 py-2">
              Tags:
            </h2>
            <div className="flex flex-wrap items-center">
              {Array.isArray(article.tags) &&
                article.tags.map((tag, index) => (
                  <span
                    key={index}
                    className="mx-2 my-1 font-bold text-white dark:text-gray-200 bg-[#01CBD9] dark:bg-gray-700 rounded-full px-3 py-1 text-md"
                  >
                    {tag}
                  </span>
                ))}
