          ...
          >
            <DialogPanel className='w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all'>
              ...
              <div className='mt-2'>
                ...
                "And Enjoy With Premium Articles!"
              ...
              <div className='flex mt-2 justify-around gap-5'>
                <Link to='/subscription-page'
                  ...
                  className='inline-flex justify-center btn-wide rounded-md border border-transparent bg-teal-600 px-4 py-2 text-sm font-medium text-white  focus:outline-none focus-visible:ring-2  focus-visible:ring-offset-2'
