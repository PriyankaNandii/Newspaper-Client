...
const TrendingArticles = () => {
    ...
    if (isError) {
        ...
        return <div className="flex justify-center items-center min-h-screen">Failed to load articles</div>;
    }
    ...
    return (
        <div className='container px-6 py-8 mx-auto'>
            <div className="text-center md:w-1/2 border-t-2 border-b-2 mx-auto p-2 my-5">
                <h1 className="text-2xl font-semibold text-gray-800 uppercase lg:text-3xl dark:text-white">Our <span className="text-[#01CBD9]">Trending Articles.</span></h1>
                        ...
                        <SwiperSlide key={index}>
                            <div>
                                <div className="relative">
                                    <img className="object-cover object-center w-full h-64 rounded-lg lg:h-80" src={article.image}  />
                                    <div className="absolute bottom-0 flex p-3 bg-white dark:bg-gray-900">
                                        <div className="mx-4">
                                            <h1 className="text-sm text-gray-700 dark:text-gray-200">Publisher: {article.publisher}</h1>
                                        </div>
                                        <div className="p-2 ">
                                        <button 
                                ...
                                <h1 className="mt-6 text-xl font-semibold text-gray-800 dark:text-white">{article.title}</h1>
