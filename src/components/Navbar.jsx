    ...
    <div className="container px-6 py-4 mx-auto md:flex md:justify-between md:items-center">
        ...
        <a className='flex'><h1 className='text-3xl m-2 font-bold text-white inline-flex items-center'><GiNewspaper className="mr-2" /> News <span className='text-[#01CBD9]'>Wisp</span></h1></a>
                        ...
                        <div className={`${isOpen ? 'translate-x-0 opacity-100' : 'opacity-0 -translate-x-full'} absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white dark:bg-gray-900 md:bg-transparent md:dark:bg-transparent md:mt-0 md:p-0 md:top-0 md:relative md:w-auto md:opacity-100 md:translate-x-0 md:flex md:items-center`}>
                            ...
                            <NavLink
                             to='/'
                            className={({ isActive }) => isActive ? 'p-2 border-[#01CBD9] border-2 rounded-xl font-extrabold text-[#01CBD9]' : ' text-white'}
                            > Home
                            </NavLink>
...
<span className="">LogOut</span>
        ...
        :
        <Link to='/login' className="btn bg-[#01CBD9] border-none text-black md:px-8 rounded-full">
